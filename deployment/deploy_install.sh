#!/bin/bash
# RedHouse Installation Script for Raspberry Pi
# Phase 2: Install dependencies, run tests, enable services.
# Called by deploy.sh after git pull to ensure this runs the latest code.
