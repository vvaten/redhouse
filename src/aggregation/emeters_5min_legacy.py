#!/usr/bin/env python3
"""
LEGACY: 5-minute energy meter data aggregation (old implementation).

This file contains the original monolithic implementation before the refactoring
to use AggregationPipeline base class. Kept for reference only.

DO NOT USE - Use Emeters5MinAggregator class in emeters_5min.py instead.
"""
...
logger = setup_logger(__name__, "emeters_5min_legacy.log")
